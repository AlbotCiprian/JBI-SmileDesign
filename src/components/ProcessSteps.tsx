    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-jbi-soft/30 to-white py-16 sm:py-28">
      <div className="container-x">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="section-title mt-4">Etapele unei consultații</h2>
          <p className="mt-4 text-base text-jbi-navy/65 sm:text-lg">
            De la primul contact până la recomandările finale, fiecare etapă este
            gândită să fie clară, confortabilă și transparentă.
          </p>
        </div>
            ...
            {processSteps.map((step, i) => (
              ...
              >
                <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-soft ring-2 ring-jbi-blue">
                  <span className="font-display text-lg font-semibold text-jbi-blue">
                    {step.n}
                  </span>
                </div>
